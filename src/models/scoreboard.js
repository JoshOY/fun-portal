...
export default () => {
  ...
  // TODO: cache
  Scoreboard.getScoreboardAsync = async function () {
    return await Scoreboard.calcScoreboardAsync();
  };

  // TODO: Rewrite to become simpler
  Scoreboard.calcScoreboardAsync = async function () {
